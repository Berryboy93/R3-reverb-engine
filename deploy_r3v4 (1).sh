#!/usr/bin/env bash
# =============================================================================
# R3V4 Space Engine — Professional Deployment Script v1.2
# =============================================================================
set -euo pipefail
...
# All logging goes to stderr so it never pollutes function return values
...
# =============================================================================
# FIND TARGET FILE — returns ONLY the path on stdout, all logs to stderr
# =============================================================================
find_target() {
  local target="$1"
  ...
  local search_paths=(
    "./r3v4_space_engine.html" "./index.html"
    "./src/r3v4_space_engine.html" "./src/index.html"
    "./public/r3v4_space_engine.html" "./public/index.html"
    "./dist/r3v4_space_engine.html" "./dist/index.html"
    "./build/r3v4_space_engine.html" "./build/index.html"
    "./static/r3v4_space_engine.html" "./static/index.html"
    "./templates/r3v4_space_engine.html" "./templates/index.html"
    "./www/r3v4_space_engine.html" "./www/index.html"
    "./html/r3v4_space_engine.html" "./html/index.html"
    "./client/r3v4_space_engine.html" "./client/index.html"
    "./frontend/r3v4_space_engine.html" "./frontend/index.html"
    "./app/r3v4_space_engine.html" "./app/index.html"
    "./web/r3v4_space_engine.html" "./web/index.html"
    "./ui/r3v4_space_engine.html" "./ui/index.html"
    "./pages/r3v4_space_engine.html" "./pages/index.html"
  )
...
while [[ $# -gt 0 ]]; do
  case "$1" in
    ...
    -*)
      ...
      echo "Usage: $0 [--new] [path/to/file.html]" >&2
      exit 1
      ;;
    *)
      TARGET="$1"
...
# Capture ONLY the path from find_target (logs go to stderr)
RESOLVED=$(find_target "$TARGET" "$CREATE_NEW") || {
  ...
  echo "  $0                          Auto-detect and replace" >&2
  echo "  $0 path/to/file.html        Replace specific file" >&2
  echo "  $0 --new path/to/file.html  Create/overwrite at path" >&2
  echo ""
  exit 1
}
